...
SELECT Register('admin', 'admin', 'admin', '2004-10-09', 1, '\x1234567890ABCDEF');
...
select AddTrack('Название трека', '2024-05-08', NULL, 'содержимое трека', 1);
CALL AddTrack('Название трека', '2024-05-08', NULL, 'содержимое трека', 1);
