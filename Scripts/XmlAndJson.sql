...
SELECT EXPORT_USERS_TO_JSON_FILE('D:\DATA\JSON\USERS.JSON');
...
SELECT IMPORT_USERS_FROM_JSON_FILE('D:\DATA\JSON\USERS.JSON');
...
SELECT EXPORT_USERS_TO_XML_FILE('D:\DATA\XML\USERS.XML');
------------- EXPORT ---------------
...
SELECT   IMPORT_USERS_FROM_XML_FILE('D:\DATA\XML\USERS.XML');
------------- IMPORT --------------- 
